...
async def get_morning_report_mock():
    ...
    mock_signals = [
        ...
        AnalyzeResponse(
            symbol="LINK", signal_id=2, timestamp=datetime.now().isoformat(),
            direction="BULLISH", confidence=68, suggested_action="Long Spot",
            accumulation_score=70, distribution_score=25,
            reasoning="On-chain accumulation detected with smart money increasing LINK positions. Oracle adoption expanding with new protocol integrations. Wyckoff markup phase forming above key support.",
            entry_zone={"low": 14.50, "high": 16.20, "ideal": 15.30},
            stop_loss=13.80, tp1=18.50, tp2=21.00, risk_reward=2.8,
            three_laws_check={"law_1_risk": "pass", "law_2_rr": "pass", "law_3_positions": "pass", "overall": "approved"},
            wyckoff_phase="Markup",
            nansen_summary=[
                "Smart money wallets accumulating — 6 large wallets added 2.1M LINK in past 72h, bullish signal",
                "Exchange outflows steady — net 850K LINK withdrawn from exchanges this week",
                "Fresh wallet activity rising — 120 new wallets with >5K LINK created, accumulation pattern",
                "Buy pressure building — top PnL traders 65% long, positive momentum shift",
                "Whale activity bullish — 2 whale wallets moved 1.5M LINK to cold storage",
            ],
            ta_summary="RSI at 62 trending up. Golden cross forming on daily. Strong support at 14.50 with increasing volume.",
        ),
        # BTC: Avoid signal — tests null entry_zone/stop/tp rendering and empty nansen_summary
        AnalyzeResponse(
            symbol="BTC", signal_id=3, timestamp=datetime.now().isoformat(),
